    ...
    Route::name('user-management.')->group(function () {
        ...
        Route::middleware(['permission:county users management'])->group(function () {
            Route::prefix('/user-management/county-users')->name('county-users.')->group(function () {
                ...
                Route::get('/user/disable/{id}', [UserManagementController::class,'usersDisable'])->name('disable');
                Route::get('/user/active/{id}', [UserManagementController::class,'usersActive'])->name('active');
