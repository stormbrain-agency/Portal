...
class W9MailUser extends Mailable
{
    ...
    protected function getEmailContent(): array
    {
        ...
        if (in_array('W9 Email User', $nameForms)) {
            foreach ($nameForms as $nameForm) {
                if ($nameForm === 'W9 Email User') {
        ...
        return [
            'subject' => 'Confirmation: W-9 Submission Received!',
            'body' => 'We have received your W-9 submission. The details of the submission are as follows:',
