                        ...
                        <div class="input-group mb-7 justify-content-between gap-7">
                            ...
                            <div class="d-flex flex-column flex-grow-1">
                                ...
                                <select class="form-select" id="name_form" name="name_form">
                                    <option value="MRAC/ARAC Admin" @if($notification->name_form == 'MRAC/ARAC Admin') selected @endif>mRec/aRec Admin</option>
                                    <option value="MRAC/ARAC User" @if($notification->name_form == 'MRAC/ARAC User') selected @endif>mRec/aRec User</option>
