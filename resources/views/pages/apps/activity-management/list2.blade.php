        ...
        <script>
         $(document).ready(function () {
            ...
            $('#user-filter').on('select2:select', function (e) {
                ...
                // window.LaravelDataTables['activity-table'].column('full_name:name').search(value).draw();
                window.LaravelDataTables['activity-table'].column('users.full_name:name').search(value).draw();
