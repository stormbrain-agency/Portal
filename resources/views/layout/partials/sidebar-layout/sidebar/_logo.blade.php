...
<div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
	...
	<!--begin::Minimized sidebar setup:
        ...
        -->
	{{-- <div id="kt_app_sidebar_toggle" class="app-sidebar-toggle h-30px w-30px btn-menu-header d-flex justify-content-center align-items-center" data-kt-toggle="true" data-kt-toggle-state="active" data-kt-toggle-target="body" data-kt-toggle-name="app-sidebar-minimize">
	...
	<a  href="{{ route('dashboard') }}">
		...
		<img id="logo" alt="Logo" src="{{ asset('libs/images/logo.png') }}" class="app-sidebar-logo-default w-100" />
		<img id="logo" alt="Logo" src="{{ asset('libs/images/logo.png') }}" class="app-sidebar-logo-minimize" />
	</a>
	<!--end::Logo image-->
