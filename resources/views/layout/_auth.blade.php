...
@section('content')
    ...
    <div class="d-flex flex-column flex-root app-root" id="kt_app_root">
        ...
        <div class="d-flex flex-column flex-lg-row flex-column-fluid">
            ...
            <!--begin::Aside-->
            <div class="d-flex flex-lg-row-fluid w-lg-50 bgi-size-cover bgi-position-center order-1 order-lg-2" style="background-image: url({{ asset('assets/images/background/effects.png') }}); background-color: #002559; background-position:100%; ">
                <!--begin::Content-->
